package com.myq.wordcount

import org.apache.spark.rdd.RDD
import org.apache.spark.{SparkConf, SparkContext}

/**
  * 本地提交spark任务方法：--需要winutils.exe才能在本地提交，方便调试
  *
  * 1.将src\main\resources\hadoop-common-2.2.0-bin-master.rar解压
  * 2.配置环境变量HADOOP_HOME以及Path即可
  */
object SparkWordCount {
  def main(args: Array[String]): Unit = {
    ...
    // 获取数据
    val lines: RDD[String] = sc.textFile("hdfs://192.168.10.101:9000/wordcount")
